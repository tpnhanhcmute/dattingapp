        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardSwiped(Direction direction) {
                ...
                if (direction == Direction.Right){
                    Toast.makeText(MainActivityTest.this, "Direction Right", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Left){
                    Toast.makeText(MainActivityTest.this, "Direction Left", Toast.LENGTH_SHORT).show();
                }
                // Paginating
